...
const BASE_INGREDIENTS = [
  ...
  ['Flour', 'Pantry', 'g', 'kg', 0.95, 1.25],
  ['Whole wheat flour', 'Pantry', 'g', 'kg', 1.25, 1.55],
  ['Sugar', 'Pantry', 'g', 'kg', 1.15, 1.35],
  ['Brown sugar', 'Pantry', 'g', 'kg', 1.60, 1.90],
  ['Salt', 'Spices', 'g', 'kg', 0.70, 0.90],
  ['Black pepper', 'Spices', 'g', 'kg', 16.00, 18.00],
  ['Paprika', 'Spices', 'g', 'kg', 15.00, 17.00],
  ['Cumin', 'Spices', 'g', 'kg', 18.00, 21.00],
  ['Cinnamon', 'Spices', 'g', 'kg', 16.00, 19.00],
  ['Oregano', 'Spices', 'g', 'kg', 20.00, 24.00],
  ['Curry powder', 'Spices', 'g', 'kg', 16.00, 19.00],
  ['Chili flakes', 'Spices', 'g', 'kg', 22.00, 26.00],
  ['Baking powder', 'Pantry', 'g', 'kg', 7.00, 8.50],
  ['Yeast', 'Pantry', 'g', 'kg', 12.00, 14.00],
  ['Butter', 'Dairy', 'g', 'kg', 7.50, 8.80],
  ['Mozzarella', 'Dairy', 'g', 'kg', 8.50, 10.00],
  ['Cheddar', 'Dairy', 'g', 'kg', 9.00, 10.80],
  ['Oats', 'Pantry', 'g', 'kg', 1.45, 1.75],
  ['Corn flakes', 'Pantry', 'g', 'kg', 4.00, 4.80],
  ['Bananas', 'Produce', 'g', 'kg', 1.25, 1.55],
  ['Apples', 'Produce', 'g', 'kg', 1.80, 2.20],
  ['Oranges', 'Produce', 'g', 'kg', 1.50, 1.90],
  ['Strawberries', 'Produce', 'g', 'kg', 5.50, 6.70],
  ['Blueberries', 'Produce', 'g', 'kg', 9.50, 11.00],
  ['Zucchini', 'Produce', 'g', 'kg', 2.10, 2.60],
  ['Bell pepper', 'Produce', 'g', 'kg', 3.20, 3.90],
  ['Eggplant', 'Produce', 'g', 'kg', 2.80, 3.30],
  ['Cauliflower', 'Produce', 'g', 'kg', 2.70, 3.20],
  ['Cabbage', 'Produce', 'g', 'kg', 1.60, 1.90],
  ['Pork loin', 'Protein', 'g', 'kg', 5.80, 7.20],
  ['Pork chops', 'Protein', 'g', 'kg', 6.20, 7.50],
  ['Cod', 'Protein', 'g', 'kg', 12.00, 15.00],
  ['White fish', 'Protein', 'g', 'kg', 9.00, 11.00],
  ['Lentils', 'Pantry', 'g', 'kg', 2.40, 2.90],
  ['Red beans', 'Pantry', 'can', 'can', 0.95, 1.15],
  ['Kidney beans', 'Pantry', 'can', 'can', 0.95, 1.15],
  ['Quinoa', 'Pantry', 'g', 'kg', 5.80, 6.80],
  ['Canned tomatoes', 'Pantry', 'can', 'can', 0.85, 1.05],
  ['Tomato paste', 'Pantry', 'g', 'kg', 4.50, 5.20],
  ['Honey', 'Pantry', 'g', 'kg', 7.00, 8.50],
  ['Vinegar', 'Pantry', 'ml', 'l', 1.80, 2.20],
  ['Mayonnaise', 'Pantry', 'g', 'kg', 4.00, 4.60],
  ['Mustard', 'Pantry', 'g', 'kg', 3.50, 4.20],
  ['Frozen mixed vegetables', 'Frozen', 'g', 'kg', 2.20, 2.60],
  ['Frozen berries', 'Frozen', 'g', 'kg', 5.50, 6.50]
];
