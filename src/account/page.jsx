...
function AccountContent({ user }) {
  ...
  async function saveProfile(event) {
    ...
    try {
      ...
      await supabase
        .from('profiles')
        .upsert({ id: user.id, email: user.email, display_name: cleanUsername });
  ...
  return (
    <AppFrame user={user} title="Account hub" subtitle="Manage your tryPan identity and sign-in settings." eyebrow="Settings">
