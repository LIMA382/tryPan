...
function AccountContent({ user }) {
  ...
  return (
    <AppFrame user={user} title="Account hub" subtitle="Manage your username, sign-in settings, and ingredient price region." eyebrow="Settings">
      ...
      <div className="account-grid">
        <form className="panel-soft account-card" onSubmit={saveProfile}>
          ...
          <div className="field">
            ...
            <p className="field-help">This controls ingredient suggestions and default estimated prices.</p>
          </div>
