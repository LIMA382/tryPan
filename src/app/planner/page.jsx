...
import { buildPantryAwareGroceryList, loadAllVisibleMeals, loadPantryItemsForUser, loadPlanForUser, setPlannedMealForUser } from '@/lib/dataStore';
...
function PlannerContent({ user }) {
  ...
  return (
    <AppFrame
      ...
      subtitle="Choose a meal from the tray, then click a lunch or dinner slot. The week now runs horizontally."
        ...
        <div className="planner-horizontal page-transition">
          ...
          <section className="planner-board panel-soft">
            <div className="planner-board-header">
              <div>
                <h3>Calendar</h3>
                <p>Lunch and dinner are rows. Days run left to right.</p>
              </div>
            ...
            <div className="horizontal-calendar-wrap">
              <div className="horizontal-calendar">
                ...
                {DAYS.map((day) => (
                  <div className="calendar-day-header" key={day}>{day.slice(0, 3)}</div>
                ))}
